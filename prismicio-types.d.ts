...
/**
 * Item in *Experience → Default → Primary → Reapeatable Zone*
 */
export interface ExperienceSliceDefaultPrimaryReapeatableZoneItem {
  /**
   * Title field in *Experience → Default → Primary → Reapeatable Zone*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.reapeatable_zone[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Time Period field in *Experience → Default → Primary → Reapeatable Zone*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.reapeatable_zone[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Institution field in *Experience → Default → Primary → Reapeatable Zone*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.reapeatable_zone[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  institution: prismic.KeyTextField;

  /**
   * Description field in *Experience → Default → Primary → Reapeatable Zone*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.reapeatable_zone[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
export interface ExperienceSliceDefaultPrimary {
  ...
  /**
   * Reapeatable Zone field in *Experience → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.reapeatable_zone[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  reapeatable_zone: prismic.GroupField<
    Simplify<ExperienceSliceDefaultPrimaryReapeatableZoneItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExperienceSlice,
      ExperienceSliceDefaultPrimaryReapeatableZoneItem,
